...
function runLoadingScreen(callback) {
  ...
  // Hard cap: always fires after 5 seconds
  ...
  const msgInt = setInterval(() => {
    if (txtEl && msgIdx < loadingMessages.length) {
...
// ============================================
// AUTO CLICKER — interval based on shop level
...
// ============================================
// LEADERBOARD — top 100 real players, no bots
// ============================================
const realNames = [
...
function renderLeaderboard(type) {
  ...
  // 99 realistic player names (no bots)
